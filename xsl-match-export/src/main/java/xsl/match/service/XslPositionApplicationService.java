...
public interface XslPositionApplicationService {
    ...
    /** 查询指定职位的所有申请 */
    List<XslPositionApplication> getAllApplyByPosition(String positionId)throws RuntimeException;
    /** 查询指定用户的所有申请 */
    List<XslPositionApplication> getAllApplyByUser(String userId)throws RuntimeException;
}
